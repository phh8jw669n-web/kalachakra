...
Each item is the 117-D observer-dependent target feature (39 local ++ 78 horizon-gated chords)
for a random ``(lat, lon, jd)``. The training loop feeds the local 33 (as 11x3 tokens) to the
model and uses the full 117-D for the isometric target distance.
"""
