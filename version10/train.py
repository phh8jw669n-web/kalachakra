...
def parse_args(argv=None):
    ...
    p.add_argument("--tv-weight", type=float, default=0.05,
                   help="total-variation spatial-smoothness weight (0 disables; anti high-freq noise)")
    p.add_argument("--tv-delta", type=float, default=0.75, help="TV neighbour offset in degrees")
...
def build_config(args):
    ...
    train = TrainConfig(lr=args.lr, lr_min=args.lr_min, warmup_steps=args.warmup,
                        ...
                        w_rel=args.w_rel, gate_k=args.gate_k, tv_weight=args.tv_weight,
                        tv_delta_deg=args.tv_delta, anchor_weight=args.anchor_weight,
