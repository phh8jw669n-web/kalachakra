...
// PER VERTEX in shader9.js; the GPU interpolates colour across triangles. The CPU computes the
// 11 Earth-fixed body directions + GMST once per frame and hands them to the shader. Around the
// field: a world map (geo.js), the 11 bodies as 3D spheres (planets9.js), the full v5-style
...
import { createPlanets } from "./planets9.js";
