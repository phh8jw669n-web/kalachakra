#!/usr/bin/env python3
"""Export a trained version9 checkpoint to weights.json (+ a golden parity file).
...
def export(checkpoint: str, out_path: str) -> str:
    ...
    from version9 import state as st
    from version9.training import export_weights_json, load_checkpoint
...
def main(argv=None) -> int:
    ...
    p.add_argument("--out", default="version9/web/weights.json")
